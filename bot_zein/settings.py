...
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,zeinedtech.uz,zein-edtech.uz,zein-admin.onrender.com').split(',')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'zein'),
...
# Check if DATABASE_URL is set (useful for Render)
